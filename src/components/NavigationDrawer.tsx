...
function DrawerList({ onPressListItem }) {
    return (
        <ScrollView>
            <NavItem onPress={onPressListItem} screen={'QRGenerator'} title={'QR Generator'} />
            <NavItem onPress={onPressListItem} screen={'QRScanner'} title={'QR Scanner'} />
        </ScrollView>
    )
}
